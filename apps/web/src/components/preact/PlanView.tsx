  ...
  return (
    <div className="card card-border mt-5 bg-base-100" data-plan>
      <div className="card-body p-5">
        ...
        {plan.projectionNotes.length > 0 && <div className="alert alert-info mt-4 items-start text-sm"><i className="ph ph-info text-lg" aria-hidden="true" /><span>{plan.projectionNotes.join(' ')}</span></div>}
        {plan.conflicts.length > 0 && (
