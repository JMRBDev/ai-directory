    ...
    <li className="flex items-start justify-between gap-3 py-3.5">
      <div className="min-w-0">
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
          ...
          <Badge variant={stateTone}>{LOCAL_STATE_LABELS[resource.state]}</Badge>
          {resource.resource && <Badge variant={registryTone}>{REGISTRY_STATE_LABELS[resource.registryState]}</Badge>}
        </div>
